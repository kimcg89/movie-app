class e{constructor(e={}){let{tagName:t="div",props:s={},state:a={}}=e;this.el=document.createElement(t),this.props=s,this.state=a,this.render()}render(){}}function t(e){location.hash||history.replaceState(null,"","/#/");let t=document.querySelector("router-view"),[s,a=""]=location.hash.split("?"),i=a.split("&").reduce((e,t)=>{let[s,a]=t.split("=");return e[s]=a,e},{});history.replaceState(i,"");let r=e.find(e=>RegExp(`${e.path}/?$`).test(s));t.innerHTML="",t.append(new r.component().el),window.scrollTo(0,0)}class s{constructor(e){for(let t in this.state={},this.observers={},e)Object.defineProperty(this.state,t,{get:()=>e[t],set:s=>{e[t]=s,Array.isArray(this.observers[t])&&this.observers[t].forEach(e=>e(s))}})}subscribe(e,t){Array.isArray(this.observers[e])?this.observers[e].push(t):this.observers[e]=[t]}}class a extends e{constructor(){super({tagName:"header",state:{menus:[{name:"Search",href:"#/"},{name:"Movie",href:"#/movie?id=tt4520988"},{name:"About",href:"#/about"}]}}),window.addEventListener("popstate",()=>{this.render()})}render(){this.el.innerHTML=`
    ...
    `}}const l=new s({searchText:"",page:1,pageMax:1,movies:[],movie:{},loading:!1,message:"Search for the movie title!"}),c=async e=>{l.state.loading=!0,l.state.page=e,1===e&&(l.state.movies=[],l.state.message="");try{let t=await fetch(`https://omdbapi.com?apikey=7035c60c&s=${l.state.searchText}&page=${e}`),{Search:s,totalResults:a,Response:i,Error:r}=await t.json();"True"===i?(l.state.movies=[...l.state.movies,...s],l.state.pageMax=Math.ceil(Number(a)/10)):(l.state.message=r,l.state.pageMax=1)}catch(e){console.log("searchMovies error:",e)}finally{l.state.loading=!1}},d=async e=>{try{let t=await fetch(`https://omdbapi.com?apikey=7035c60c&i=${e}&plot=full`);l.state.movie=await t.json()}catch(e){console.log("getMovieDetails error:",e)}};class h extends e{render(){this.el.classList.add("search"),this.el.innerHTML=`
    <input 
    ...
    `,await d(history.state.id),console.log(l.state.movie);let{movie:e}=l.state,t=e.Poster.replace("SX300","SX700");this.el.innerHTML=`
      <div 
...
//# sourceMappingURL=index.2f013439.js.map
